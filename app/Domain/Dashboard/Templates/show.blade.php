    ...
    @displayNotification()
        ...
        <div class="row">
            ...
            <div class="col-md-8">
                ...
                <div class="maincontentinner z-20">

                    @if ($login::userIsAtLeast($roles::$admin))
                        <x-global::actions.dropdown label-text="<i class='fa fa-ellipsis'></i>" contentRole="link"
                            position="bottom" align="start" class="pull-right dropdownWrapper btn round-button"
                    ...
                    <div class="pull-right dropdownWrapper mr-[5px]">
                        <a class="dropdown-toggle btn round-button" data-toggle="dropdown"
                            data-tippy-content="{{ __('label.copy_url_tooltip') }}"
                            href="{{ BASE_URL }}/project/changeCurrentProject/{{ $project['id'] }}"><i
                                class="fa fa-link"></i></a>
                        <div class="dropdown-menu padding-md">
                            <input type="text" id="projectUrl"
                                value="{{ BASE_URL }}/projects/changeCurrentProject/{{ $project['id'] }}" />
                            <button class="btn btn-primary"
                                onclick="leantime.snippets.copyUrl('projectUrl')">{{ __('links.copy_url') }}</button>
                        </div>
                    </div>

                    <a href="javascript:void(0);" id="favoriteProject"
                        class="btn pull-right margin-right {{ $isFavorite ? 'isFavorite' : '' }} mr-[5px] round-button"
                        data-tippy-content="{{ __('label.favorite_tooltip') }}"><i
                            class="{{ $isFavorite ? 'fa-solid' : 'fa-regular' }} fa-star"></i></a>
                ...
                <div class="maincontentinner z-10">
                    <a href="#/tickets/newTicket" class="btn btn-link action-link pull-right" style="margin-top:-7px;"><i
                            class="fa fa-plus"></i> Create To-Do</a>
                    ...
                    <ul class="sortableTicketList">
                        ...
                        @foreach ($tickets as $row)
                            <li class="ui-state-default" id="ticket_{!! $row['id'] !!}">
                                <x-global::content.card content-role="primary">
                                    <x-slot:card-title>
            ...
            <div class="pull-right">
                @if ($login::userIsAtLeast($roles::$editor))
                    <a href="javascript:void(0);"
                        ...
                        id="mainToggler" class="btn btn-link action-link" style="margin-top:-7px;"><span
                            class="fa fa-plus"></span> {{ __('links.add_new_report') }}</a>
                @endif
            </div>
        ...
        <div class="maincontentinner">
            <div class="row" id="projectProgressContainer">
                <div class="col-md-12">
                    ...
                    <div id="canvas-holder" class="w-full h-[250px]">
...
<div class="ticketBox fixed priority-border-{!! $row['priority'] !!}"
                                    data-val="{!! $row['id'] !!}">
                                    <div class="row">
                                        <div class="col-md-12 timerContainer py-[5px] px-[15px]"
                                            id="timerContainer-{!! $row['id'] !!}">
                                            @if ($row['dependingTicketId'] > 0)
                                                <a href="#/tickets/showTicket/{{ $row['dependingTicketId'] }}">
                                                    {{ $row['parentHeadline'] }}
                                                </a>
